                    ...
                    <div class="row">
                        <div class="col-md-6 col-sm-6">
                            <div class="block wow fadeInLeft" data-wow-delay=".3s" data-wow-duration="500ms">
                                <form>
                                  Deskripsi:<br>
                                  <input type="text" name="detail" style="width: 400px; height: 300px;">
                                  <br><br>
                                  <input class="btn-lines dark light wow fadeInUp animated smooth-scroll btn btn-default btn-green" type="submit" value="Submit">
                                </form>
                            </div>
