            ...
            <div class="box-body">
              <div class="col-md-12">
                <h3>
                  ...
                  <div class="col-md-9">{{$dosen->nama}}</div>
                </h3>
              </div>
              <div class="col-md-12">
                <h3>
                  <div class="col-md-3">NIP:</div>
                  <div class="col-md-9">{{$dosen->nip}}</div>
                </h3>
              </div>
              <div class="col-md-12">
                <h3>
                  <div class="col-md-3">Email:</div>
                  <div class="col-md-9">{{$dosen->email}}</div>
                </h3>
              </div>  
              <div class="col-md-12">
                <h3>
                  <div class="col-md-3">Kontak:</div>
                  <div class="col-md-9">{{$dosen->no_hp}}</div>
                </h3>
              </div>
              <div class="col-md-12">
                <h3>
                  <div class="col-md-3">Alamat:</div>
                  <div class="col-md-9">{{$dosen->alamat}}</div>
                </h3>
              </div>              
            </div>
            <!-- /.box-body -->
